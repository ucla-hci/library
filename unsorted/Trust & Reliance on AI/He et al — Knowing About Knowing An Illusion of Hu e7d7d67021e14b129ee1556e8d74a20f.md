# He et al. — Knowing About Knowing: An Illusion of Human Competence Can Hinder Appropriate Reliance on AI Systems
...
articleno = {113},
numpages = {18},
keywords = {Appropriate Reliance, Dunning-Kruger Effect, Human-AI Decision Making, XAI},
...
> … a metacognitive bias due to which individuals overestimate their competence and performance.
> 

> … participants representing the bottom performance quartile tend to overestimate their skill and depict an illusory superiority, while those in the top performance quartile do not exhibit such a trend.
> 

### The main findings

> We found a negative impact of the DKE on human reliance behavior, where participants with DKE, relied significantly less on the AI system than their counterparts without DKE.
> 

> Although we found that the intervention tutorial was highly effective in improving participants’ self-assessments, their improvement in appropriate reliance and performance is limited (statistically non-significant).
> 
