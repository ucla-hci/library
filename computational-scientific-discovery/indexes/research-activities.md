...
Selecting, constructing, or reframing research questions and goals.
...
## Literature Discovery (21)

Finding, connecting, or synthesizing relevant prior knowledge.
...
Choosing the objects, variables, formats, or visualizations through which data are understood.
...
Choosing experimental paradigms, interventions, measurements, controls, or parameter settings.
...
## Experiment Execution (8)

Carrying out physical or computational experiments and simulations.
...
Transforming, exploring, or modeling data to extract patterns and results.
...
Writing, reviewing, explaining, or otherwise sharing research outputs.
...
Coordinating people, agents, expertise, artifacts, or shared understanding.
...
Integrating research activities into a managed computational, robotic, or agentic process.
...
Supporting provenance, replication, data stewardship, or reuse.
