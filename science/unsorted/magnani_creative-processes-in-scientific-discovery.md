...
### Another way of describing abduction
> `[`It`]` is a matter of utilizing the principle of maximum likelihood in order to formalize a pattern of reasoning known as *inference to the best explanation* (Fetzer, 1990, p.103)

### Deduction vs. reduction
>Reasoning which starts from reasons and looks for consequences is called *deduction*; that which starts from consequences and looks for reasons is called *reduction*

### Selective abduction
> the selection of a ... hypothesis from a set of pre-enumerated hypotheses ... deals with a kind of *rediscovery*, instead of a genuine discovery

### What is required of strategic abduction
> ... to have *a set of criteria for evaluating* the computing explanatory hypotheses reached by creative or selective abudction
