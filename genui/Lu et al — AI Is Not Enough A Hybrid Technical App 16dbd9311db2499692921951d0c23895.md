...
> … detecting and correcting violations of design system guidelines …
> 

Design systems

> … usually contain a set of user interface (UI) components and can offer guidance for layout, visual aesthetics, and user task flows.
> 

### This project’s formative study

> … multi-day, in-person workshop with designers and UX researchers to understand current linting practices and needs.
> 

> … summarized designers’ three unique needs in UI linting: tight alignment with design system guidelines, high precision in detailed evaluation, and clear explanation of violations for smooth handoff.
> 
